...
> <!-- DESCRIPTION:START -->
> Its about a test automation tool
> <!-- DESCRIPTION:END -->
...
## 💻 CodeSnippet
<!-- CODE_SNIPPET:START -->
// Extract repository name from RDEData section (or use GitHub repo name as fallback)
        var repositoryName = _openAIService.ExtractRepositoryName(readmeContent, repository.Name);

        // Extract Usage Guide fields from README comment markers
        var installCommand = ExtractFromReadmeMarkers(readmeContent, "INSTALLATION");
        var quickstartCode = ExtractFromReadmeMarkers(readmeContent, "CODE_SNIPPET");
<!-- CODE_SNIPPET:END -->
